...
import {
    getEmployeeById, getDocumentForEmployee,
...
const RepresentationForm = (props) => {
    ...
    const [principalCompany, setPrincipalCompany] = useState(props.principalCompany);
    const categories = props.categories;
    const [category, setCategory] = useState({});
    const [reason, setReason] = useState("confirmation");
    const [qualification, setQualification] = useState(props.employee.qualification);
    const [overallWorkExperience, setOverallWorkExperience] = useState("");
    const [lastPositionWorkExperience, setLastPositionWorkExperience] = useState("");
    ...
    const onChangeCategory = (e) => {
        ...
        const newCategory = categories.find((c) => c.representationLabel === newCategoryRepresentationLabel);
        setCategory(!isFalseObject(newCategory) ? newCategory : {});
    };

    const handleSubmit = useCallback((e) => {
        const documentDto = {
            principalCompany, ...(reason === "assignment" && {categoryAssignment: true}), ...(reason === "confirmation" && {
    ...
    }, [fetchDocument, principalCompany, reason, category, qualification, overallWorkExperience, lastPositionWorkExperience, recommendation, showing, flaws,]);
    ...
    return (<div className="Form">
        ...
        >
            ...
            <form className="form" onSubmit={handleSubmit}>
                ...
                <div className="text-field"><MyTextField
                    disabled
                    label="ФИО"
